...

{
    ...
    "0x802EB008" : "(4 bytes) -- Options Menu: g_savedDrawStart, the UI element-loop start bound (0x803CBC98) saved beside g_savedDrawEnd by MS_BlankDraw; only meaningful while g_savedDrawEnd holds a real bound",
